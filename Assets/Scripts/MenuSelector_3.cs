...
public class MenuSelector_3 : MonoBehaviour
{
	...
	CharacterPointer.State state = menuNav.GetComponent<CharacterPointer>().state;

	if (state != CharacterPointer.State.ListDisplayed)
	{
